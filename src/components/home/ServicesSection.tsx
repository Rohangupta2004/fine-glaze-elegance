...
const services: Service[] = [
  {
    ...
    description: "Curtain walls, structural glazing, and unitized facades built for long-term performance.",
  ...
  },
  {
    ...
    description: "Frameless and semi-frameless railing systems that balance safety with clear views.",
  ...
  },
  {
    icon: DoorOpen,
    title: "Doors & Windows",
    description: "High-performance aluminium systems with thermal efficiency for modern architecture.",
  ...
  },
  {
    icon: Wrench,
    title: "AMC Services",
    description: "Preventive maintenance, facade cleaning, and repairs to keep systems operating reliably.",
...
export const ServicesSection = () => {
  ...
  return (
    <section className="py-20 bg-muted" ref={ref} aria-labelledby="home-services-heading">
      <div className="container mx-auto px-4">
        <div className={cn("text-center space-y-4 mb-12 slide-up", isVisible && "visible")}>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Comprehensive facade, railing, and aluminium solutions delivered with precision.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <article
              key={service.title}
              className={cn(
                "group relative rounded-xl p-6 border border-border bg-card",
                "hover:border-primary/40 hover:shadow-xl transition-all duration-300 slide-up",
                isVisible && "visible"
              )}
