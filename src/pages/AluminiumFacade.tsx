import { Card, CardContent } from "@/components/ui/card"; import { Button } from "@/components/ui/button"; import { Building2, Layers, ShieldCheck, Phone } from "lucide-react";

export default function FineGlazeLanding() { return ( <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100"> {/* Hero */} <section className="px-6 py-20 max-w-7xl mx-auto text-center"> <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900"> FineGlaze </h1> <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto"> Premium Facade • Aluminium • Glass Solutions </p> <div className="mt-8 flex gap-4 justify-center"> <Button className="rounded-2xl px-6">Get Quote</Button> <Button variant="outline" className="rounded-2xl px-6">View Projects</Button> </div> </section>
