...
import { ThreeHeroSection } from "@/components/home/ThreeHeroSection";
            ...
            <Card className="border border-white/15 bg-slate-900 text-white">
              <CardContent className="space-y-4 p-6">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs text-slate-300">
                  ...
                  <span className="rounded-md border border-white/20 p-2">Glass: {glassTone}</span>
                  <span className="rounded-md border border-white/20 p-2">Frame: {frameColor}</span>
                </div>
              </CardContent>
            </Card>
          </div>
