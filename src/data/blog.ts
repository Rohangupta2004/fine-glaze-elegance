...
export const blogPosts: Record<string, BlogPost> = {
  ...
  "acp-cladding-installation-process-india": {
    ...
    title: "ACP Cladding Installation Process in India: Step-by-Step Guide (2026)",
    metaTitle: "ACP Cladding Installation Process India 2026 | Step-by-Step Guide – Fine Glaze",
    metaDescription: "Complete step-by-step guide to ACP cladding installation in India. From surface preparation to final sealing — tools, substrate types, fixing methods, and cost breakdown for 2026.",
    keywords: "ACP cladding installation process India, ACP panel installation steps, aluminium composite panel fixing method, ACP cladding contractor Pune Mumbai, ACP installation guide India 2026, ACP cladding substrate preparation",
    date: "2026-05-15",
    readTime: "9 min read",
    category: "How-To",
    heroImage: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200&q=80",
    excerpt: "A complete step-by-step breakdown of how ACP cladding is installed in India — from structural checks and substrate preparation through panel fabrication, fixing, and final sealant application.",
    content: [
      { heading: "What is ACP Cladding and Why is it Popular in India?", body: "Aluminium Composite Panel (ACP) cladding is one of the most widely used exterior facade systems in India for commercial buildings, IT parks, retail showrooms, hospitals, and high-rise residential projects. ACP consists of two thin aluminium sheets bonded to a polyethylene or fire-retardant mineral core, giving it exceptional rigidity at very low weight. In India, ACP cladding is popular because it is cost-effective (₹180–₹450/sq ft installed), available in hundreds of colours and finishes, quick to fabricate, and requires low maintenance. Cities like Pune, Mumbai, Hyderabad, Bengaluru, and Delhi have seen massive adoption of ACP facades over the last decade." },
      { heading: "Types of ACP Panels Used in India", body: "Not all ACP panels are equal. Understanding the types helps you specify the right product:", table: { headers: ["ACP Type", "Core Material", "Fire Rating", "Best For", "Approx. Price (₹/sq ft)"], rows: [["Standard ACP", "Polyethylene (PE)", "Non fire-rated", "Interiors, low-rise facades", "₹35 – ₹55"], ["Fire Retardant (FR) ACP", "Mineral-filled FR core", "FR rated (Class B-s3)", "Facades above 15m height", "₹55 – ₹85"], ["A2 Fire-Rated ACP", "Non-combustible mineral core", "A2 (Class A)", "High-rise, hospitals, airports", "₹90 – ₹150"], ["Nano-Coated ACP", "PE or FR core with nano coating", "FR rated", "Coastal/high-pollution areas", "₹75 – ₹120"], ["Brushed / Wooden ACP", "PE core with textured finish", "Non fire-rated", "Feature walls, interiors", "₹60 – ₹100"]] } },
      { heading: "Step 1 — Site Survey & Structural Assessment", body: "Before any ACP installation begins, a thorough site survey is essential:", list: ["Measure all elevations accurately using laser distance meters or total stations.", "Inspect the primary structure (RCC, steel frame, or masonry) for load capacity to carry the secondary framing and ACP panels.", "Identify critical areas: corners, parapets, window reveals, expansion joints, and drainage points.", "Check the building plumb and level — deviations above 20mm per floor need shimming or correction in the framework design.", "Prepare shop drawings and facade panel layout drawings for client and structural approval before fabrication begins."] },
      { heading: "Step 2 — Fabrication of ACP Panels", body: "ACP panels are custom fabricated in the workshop to exact dimensions from the shop drawings:", list: ["Panels are CNC-routed on the back side to create V-grooves for folding at corners (typically 90° folds for returns).", "Routing depth must leave 0.3–0.5mm of aluminium skin at the bend — too deep causes cracking, too shallow causes poor folding.", "Panel edges are folded using a press brake to form a cassette profile (typically 25–50mm returns).", "Rivet or screw holes are pre-drilled in the returns for later fixing to sub-frame cleats.", "Panels are cut to account for 8–10mm sealant joint gaps between panels.", "Quality check: each panel inspected for surface scratches, edge uniformity, and dimensional accuracy."] },
      { heading: "Step 3 — Sub-Frame (Secondary Structure) Installation", body: "The sub-frame carries the ACP panels and transfers load to the primary structure. This is the most critical phase:", list: ["Anchor bolts or chemical anchors are fixed into the primary structure at 600–900mm centres, both horizontally and vertically.", "Horizontal aluminium channels (typically 100×50mm or 75×50mm extruded aluminium) are installed as the primary rail.", "Vertical aluminium Z-sections or T-sections are fixed to the horizontal rails at panel joint locations.", "Ensure rails are plumb, level, and in plane — laser alignment is used on large projects.", "The sub-frame must accommodate 10–15mm movement allowance for thermal expansion (aluminium expands ~2.3mm per metre per 100°C).", "All aluminium sub-frame components must use T6 temper alloy (6063-T6 or 6061-T6) — never use lower grades.", "For coastal locations (Mumbai, etc.), use stainless steel or hot-dip galvanised anchor hardware to prevent corrosion."] },
      { heading: "Step 4 — Panel Fixing Methods", body: "The two primary ACP panel fixing methods used in India:", table: { headers: ["Fixing Method", "How It Works", "Visible Fasteners?", "Best Application", "Relative Cost"], rows: [["Exposed Rivet / Screw Fix", "Panels screwed/riveted through face to sub-frame", "Yes", "Industrial, economy projects", "Low"], ["Hidden Cleat Fix (Recommended)", "Aluminium cleats riveted to panel returns; cleat hooks onto rail", "No", "Premium commercial facades", "Medium"], ["Structural Silicone Bond", "Panels bonded to carrier frame with silicone only", "No", "Feature facades, showrooms", "High"], ["Combination Fix", "Mechanical fix + silicone backing", "Minimal", "High-wind coastal zones", "Medium-High"]] } },
      { heading: "Step 5 — Panel Installation Sequence", body: "The correct sequence avoids rework and ensures a watertight result:", list: ["Always start installation from the lowest panel row and work upward — this allows upper panels to overlap lower ones and shed water.", "Install corner panels and returns first, then fill in field panels.", "Check panel alignment and joint width (8–10mm) with plastic spacers before final fixing.", "Rivet or fix cleats as per engineering specification — do not over-tighten fixings, which causes panel 'oil-canning' (waviness).", "On large facades, use temporary panel props or suction cups to hold panels during cleat engagement.", "Keep protective film on panels during installation — remove only after all sealant work is complete."] },
      { heading: "Step 6 — Sealant Application", body: "Sealant is the final weatherproofing barrier between panels:", list: ["Use neutral-cure silicone sealant (Dow Corning 791 / Sika 991 / GE SCS2000 or equivalent) — never use acetoxy/acetic cure silicone on aluminium (causes corrosion).", "Apply backing rod (backer rod) in joint to control sealant depth — sealant depth should be 50% of joint width (e.g., 5mm deep for 10mm joint).", "Apply masking tape on panel faces on both sides of joint before sealing — ensures clean, straight sealant bead.", "Tool the sealant within 10 minutes of application using a wet finger or tooling stick.", "Remove masking tape at 45° angle immediately after tooling — do not wait for curing.", "Cure time: 24–48 hours at ambient temperature. Do not wash panels for 72 hours after sealing.", "Inspect every joint after curing for voids, bubbles, or adhesion failure."] },
      { heading: "Step 7 — Drainage & Ventilation Design", body: "A properly designed ACP facade is a 'rain screen' — meaning it drains water rather than trying to stop it 100% at the face:", list: ["Provide weep holes or open joints at the base of each panel bay to drain any water that penetrates the outer face.", "Leave a 25–50mm ventilation cavity between the ACP panel and the wall behind — this equalises pressure and dries out any moisture.", "At parapets and roof junctions, install aluminium coping with overhang and drip edge.", "Ensure perimeter flashings at window and door interfaces are properly lapped and sealed.", "Never fully seal the bottom of a panel cassette — trapped moisture behind panels causes delamination over time."] },
      { heading: "Common ACP Installation Mistakes in India", body: "Mistakes that lead to premature failure, water leakage, or fire risk:", list: ["Using PE-core ACP on buildings above 15 metres height — violates NBC 2016 fire safety requirements.", "Skipping structural engineering for the sub-frame — leads to anchor pullout failure in high wind.", "Using acid-cure (acetic) silicone on aluminium — corrodes the panel skin within 2 years.", "Insufficient sealant joint width (less than 6mm) — joint fails under thermal movement, causing cracking.", "Removing protective film too early — scratches from tools and abrasion damage the factory finish.", "Not accounting for expansion gaps at building movement joints — panels buckle or delaminate.", "Riveting cleats directly to the outer aluminium skin face instead of the return fold — causes panel distortion."] },
      { heading: "ACP Cladding Installation Cost in India (2026)", body: "Indicative installed costs for ACP cladding across India:", table: { headers: ["Specification", "Panel Supply Cost", "Installation Labour", "Total Installed Cost"], rows: [["Economy PE-core ACP (basic colour)", "₹35 – ₹55/sq ft", "₹60 – ₹90/sq ft", "₹95 – ₹145/sq ft"], ["FR-core ACP (standard commercial)", "₹55 – ₹85/sq ft", "₹70 – ₹100/sq ft", "₹125 – ₹185/sq ft"], ["A2 Non-combustible ACP (hospital/airport)", "₹90 – ₹150/sq ft", "₹80 – ₹120/sq ft", "₹170 – ₹270/sq ft"], ["Premium PVDF-coated ACP", "₹120 – ₹200/sq ft", "₹90 – ₹130/sq ft", "₹210 – ₹330/sq ft"]] } },
      { heading: "Get a Professional ACP Cladding Installation Quote", body: "Proper ACP installation requires experienced facade contractors who understand structural engineering, fire compliance, and weatherproofing. Fine Glaze has installed ACP facades on commercial buildings, IT parks, hospitals, and residential towers across Pune and Mumbai. We handle everything — shop drawings, material supply, sub-frame fabrication, panel installation, and silicone sealing. Contact us for a free site visit and installation quote: info@fineglaze.com | +91 8369233566" }
    ]
  },
